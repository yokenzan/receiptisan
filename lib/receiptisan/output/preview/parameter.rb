...
require_relative 'parameter/nyuuinryou_abbrev_label_convertor'
require_relative 'parameter/byoushou_type_detector'
require_relative 'parameter/kijun_mark_detector'
require_relative 'parameter/hyoujun_futangaku_calculator'
